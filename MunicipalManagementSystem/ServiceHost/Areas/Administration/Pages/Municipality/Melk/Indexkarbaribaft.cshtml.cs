...
public class IndexModelkarbaribaft : PageModel
{
    ...
    public IndexModelkarbaribaft(IMelkApplication melkApplication,
    ...
    public IActionResult OnGetEdit(long id)
    {
        ...
        return Partial("karbaribaft", melk);

    }
    public JsonResult OnPostEdit(EditMelk command)
    {
        var result = _melkApplication.EditKarbaribaft(command);
        return new JsonResult(result);
    }
}