...
public class AuthHelper : IAuthHelper
{
    ...
    {
        return IsAuthenticated()
            ? _contextAccessor.HttpContext.User.Claims.First(x => x.Type == "ProfilePhoto")?.Value
            : "";
    }
    ...
    public void Signin(AuthViewModel account)
    {
        ...
        _ = _contextAccessor.HttpContext.SignInAsync(CookieAuthenticationDefaults.AuthenticationScheme,
    ...
    public void SignOut()
    {
        _ = _contextAccessor.HttpContext.SignOutAsync(CookieAuthenticationDefaults.AuthenticationScheme);
    }
}